  ...
  return (
    <>
      ...
      <section id="about" className="portfolio-section" style={{ minHeight: '90vh', display: 'flex', alignItems: 'center' }}>
        <div className="sawad-hero">
          <div className="hero-left">
            ...
            <h1 className="hero-title-sawad" style={{ minHeight: '120px' }}>
      ...
      <section id="skills" className="portfolio-section">
        ...
        <span className="skills-interactive-hint" style={{ display: 'block', marginTop: '-2.5rem', marginBottom: '2rem', color: 'var(--text-gray)', fontSize: '0.85rem' }}>
      ...
      <section id="projects" className="portfolio-section">
        ...
        <span className="skills-interactive-hint" style={{ display: 'block', marginTop: '-2.5rem', marginBottom: '2.5rem', color: 'var(--text-gray)', fontSize: '0.85rem' }}>
          ...
          <div className="timeline-row row-right">
            ...
            <div className="timeline-side-content text-side">
              <div className="education-details-card">
                ...
                <div className="edu-badge-wrapper">
                  <span className="edu-badge">Class XII</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Contact Section */}
      <section id="contact" className="portfolio-section" style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center', width: '100%' }}>
          <h2 className="sawad-section-title" style={{ textAlign: 'center', marginBottom: '1.5rem' }}>Let's Build <span>Together</span></h2>
          <p style={{ color: 'var(--text-gray)', maxWidth: '500px', margin: '0 auto 2.5rem', fontSize: '0.95rem', lineHeight: '1.6' }}>
      ...
      >
        <div className="resume-modal" onMouseLeave={() => setIsModalOpen(false)}>
          ...
          <div className="resume-header">
            ...
            <div style={{ fontSize: '0.8rem', color: 'var(--text-gray)', marginTop: '0.5rem', fontFamily: 'var(--font-sans)', userSelect: 'text' }}>
              Gauravpapnai2005@gmail.com | +91 8791132616 | Ghaziabaad, Uttar Pradesh
            </div>
          </div>
          ...
          <div className="resume-scrollable-content" style={{ userSelect: 'text' }}>
            ...
            <div className="resume-section">
              ...
              <p style={{ fontSize: '0.85rem', lineHeight: '1.6', color: 'var(--text-gray)' }}>
            ...
            <div className="resume-section">
              ...
              <div style={{ fontSize: '0.85rem', lineHeight: '1.6', color: 'var(--text-gray)' }}>
            ...
            <div className="resume-section">
              ...
              <div className="resume-item" style={{ marginTop: '1.2rem' }}>
                <div className="resume-item-header">
