...
const categoriesList = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Component-Based Architecture', level: '95%', desc: 'Creating highly modular, reusable, scalable UI blocks' },
...
export default function SkillsClothesline2D() {
  ...
  const activeCategory = categoriesList.find((cat) => cat.id === activeTab);
